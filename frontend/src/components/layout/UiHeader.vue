...
const loginUrl = computed(() => {
  return `https://паспорт.мавка.укр/oauth/authorize?client_id=1&redirect_uri=${CONFIG.PAK_APP_ULR}/handle-mavka-oauth&response_type=code&scope=id name photo email`;
});
